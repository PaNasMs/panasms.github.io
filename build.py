...
</main><footer><div class="wrap"><div class="footer-top"><div><a class="brand" href="{prefix}">PaNasMs</a><p>{e(t['footerDescription'])}</p></div><div class="footer-links"><a href="https://github.com/PaNasMs">{e(t['source'])} ↗</a><a href="https://github.com/PaNasMs/panasms/blob/main/LICENSE">{e(t['license'])} ↗</a><a href="#credits">{e(t['credits'])}</a><a href="{prefix}hardware/rpi_radxa_penta/">Hardware build (EN)</a><a href="{prefix}docs/setup/google/">Google setup (EN)</a><a href="{prefix}privacy/">Privacy</a><a href="{prefix}terms/">Terms</a></div></div><p class="legal">{e(t['licenseText'])}</p><details id="credits"><summary>{e(t['credits'])}</summary><p>{e(t['creditsText'])} <a href="https://github.com/KDE/plasma-workspace-wallpapers/tree/master/Flow">KDE Flow</a> · <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a></p></details></div></footer>
